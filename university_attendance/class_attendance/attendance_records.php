...
<head>
  ...
  <style>
    body {
      background: url('https://c4.wallpaperflare.com/wallpaper/55/513/246/half-tree-wallpaper-preview.jpg') no-repeat center center fixed;
...
<body>
  ...
  <div class="col-md-2">
    <input type="text" name="semester" placeholder="Semester" value="<?= htmlspecialchars($filter_semester) ?>" class="form-control" />
  </div>
  <div class="col-md-4 d-grid gap-2 d-md-flex justify-content-md-end">
    ...
    <div class="mb-3 d-flex justify-content-between">
      <a href="export_attendance.php?date=<?=urlencode($filter_date)?>&student=<?=urlencode($filter_student)?>&faculty=<?=urlencode($filter_faculty)?>&semester=<?=urlencode($filter_semester)?>" class="btn btn-success">Download</a>
