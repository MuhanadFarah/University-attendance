...
<footer style="font-size:12px; text-align:center; color:#ccc; padding:10px 0; position: fixed; bottom: 0; width: 100%; background-color: rgba(0, 0, 0, 0.5); z-index: 3;">
  © 2025 University Attendance Management System — Developed by Muhanad Farah Abdirahman
</footer>
</html>
